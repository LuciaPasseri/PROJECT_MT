...
public class CliOptions {
	...
	@Option(names = {
			"--filePerGraph" }, description = "Flag to write the different graphs in separate files (default: false)")
	boolean filePerGraph = false;

	@Option(names = { "-b",
			"--baseIRI" }, description = "Used in resolving relative IRIs produced by the R2RML mapping")
	String baseIRI = null;
	...
	@Option(names = {
			"--CSVFiles" }, description = "A list of paths to CSV files that are separated by semicolons (cannot be used with connectionURL)")
